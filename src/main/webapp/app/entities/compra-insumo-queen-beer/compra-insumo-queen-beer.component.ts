...
@Component({
    selector: 'jhi-compra-insumo-queen-beer',
    templateUrl: './compra-insumo-queen-beer.component.html'
})
export class CompraInsumoQueenBeerComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        if (this.currentSearch) {
            this.compraInsumoService
                ...
                .subscribe(
                    (res: HttpResponse<ICompraInsumoQueenBeer[]>) => this.paginateCompraInsumos(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/compra-insumo-queen-beer'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: ICompraInsumoQueenBeer) {
        return item.id;
    }
    ...
    private paginateCompraInsumos(data: ICompraInsumoQueenBeer[], headers: HttpHeaders) {
