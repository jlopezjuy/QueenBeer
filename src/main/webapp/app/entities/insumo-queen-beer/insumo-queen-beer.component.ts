...
export class InsumoQueenBeerComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.insumoService
                ...
                .subscribe(
                    (res: HttpResponse<IInsumoQueenBeer[]>) => this.paginateInsumos(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/insumo-queen-beer'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateInsumos(data: IInsumoQueenBeer[], headers: HttpHeaders) {
