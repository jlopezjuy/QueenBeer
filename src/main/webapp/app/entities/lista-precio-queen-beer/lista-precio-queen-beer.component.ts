...
export class ListaPrecioQueenBeerComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.listaPrecioService
                ...
                .subscribe(
                    (res: HttpResponse<IListaPrecioQueenBeer[]>) => this.paginateListaPrecios(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/lista-precio-queen-beer'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateListaPrecios(data: IListaPrecioQueenBeer[], headers: HttpHeaders) {
