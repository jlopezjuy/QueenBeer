...
public class CompraResource {
    ...
    @PutMapping("/compras")
    @Timed
    public ResponseEntity<CompraDTO> updateCompra(@RequestBody CompraDTO compraDTO) throws URISyntaxException {
    ...
    public ResponseEntity<List<CompraDTO>> getAllCompras(Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/compras");
