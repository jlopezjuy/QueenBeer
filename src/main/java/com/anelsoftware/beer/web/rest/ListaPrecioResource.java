...
public class ListaPrecioResource {
    ...
    @Timed
    public List<ListaPrecioDTO> getAllListaPrecios() {
    ...
    @Timed
    public List<ListaPrecioDTO> searchListaPrecios(@RequestParam String query) {
        log.debug("REST request to search ListaPrecios for query {}", query);
        return listaPrecioService.search(query);
    }
