...
public class ProductoResourceIntTest {
    ...
    private static final String DEFAULT_COMPLEMENTARIO = "AAAAAAAAAA";
    private static final String UPDATED_COMPLEMENTARIO = "BBBBBBBBBB";
     ...
     *
     * @see com.anelsoftware.beer.repository.search.ProductoSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Producto createEntity(EntityManager em) {
        Producto producto = new Producto()
            ...
            .complementario(DEFAULT_COMPLEMENTARIO)
    ...
    public void createProducto() throws Exception {
        ...
        assertThat(testProducto.getComplementario()).isEqualTo(DEFAULT_COMPLEMENTARIO);
    ...
    public void getProducto() throws Exception {
        ...
        restProductoMockMvc.perform(get("/api/productos/{id}", producto.getId()))
            ...
            .andExpect(jsonPath("$.complementario").value(DEFAULT_COMPLEMENTARIO.toString()))
    ...
    public void updateProducto() throws Exception {
        ...
        updatedProducto
            ...
            .complementario(UPDATED_COMPLEMENTARIO)
        ...
        assertThat(testProducto.getComplementario()).isEqualTo(UPDATED_COMPLEMENTARIO);
