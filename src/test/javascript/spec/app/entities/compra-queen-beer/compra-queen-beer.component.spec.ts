...
import { CompraQueenBeerComponent } from 'app/entities/compra-queen-beer/compra-queen-beer.component';
...
describe('Component Tests', () => {
    describe('CompraQueenBeer Management Component', () => {
        let comp: CompraQueenBeerComponent;
        let fixture: ComponentFixture<CompraQueenBeerComponent>;
        let service: CompraQueenBeerService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [QueenBeerTestModule],
                declarations: [CompraQueenBeerComponent],
                providers: [
                    {
                ...
                .overrideTemplate(CompraQueenBeerComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(CompraQueenBeerComponent);
