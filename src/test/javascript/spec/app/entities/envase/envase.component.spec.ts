...
import { EnvaseComponent } from 'app/entities/envase/envase.component';
import { EnvaseService } from 'app/entities/envase/envase.service';
import { Envase } from 'app/shared/model/envase.model';

describe('Component Tests', () => {
    describe('Envase Management Component', () => {
        let comp: EnvaseComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(EnvaseComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.envases[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
