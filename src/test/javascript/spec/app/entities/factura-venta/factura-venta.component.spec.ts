...
import { FacturaVentaComponent } from 'app/entities/factura-venta/factura-venta.component';
...
describe('Component Tests', () => {
    describe('FacturaVenta Management Component', () => {
        let comp: FacturaVentaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(FacturaVentaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.facturaVentas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
